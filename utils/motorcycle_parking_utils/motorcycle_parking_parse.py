...
format data from regular expression to tailored Motorcycle_Parking class
'''

from .motorcycle_parking_fetch import *


def parsed_parking_type():
    parking_type= get_all_parking_type()
    return parking_type
...
def parsed_r_mf_9a_6p():
    ...
    for item in raw_r_mf_9a_6p:
        if item != "null":
            ...
            parking_rate_floats.append(item)
